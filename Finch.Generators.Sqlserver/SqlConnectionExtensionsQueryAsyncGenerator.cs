...
public static class SqlConnectionExtensionsQueryAsyncGenerator
{
        ...
        ImmutableArray<ClassDeclarationSyntax> classDeclarations)
    {
        foreach (var classDeclarationSyntax in classDeclarations)
        {
            ...
            context.AddSource("SqlConnectionExtensions.QueryAsync.g.cs", SourceText.From(code, Encoding.UTF8));
            break;
        }
    }
